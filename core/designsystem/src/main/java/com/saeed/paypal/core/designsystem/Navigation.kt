...
/**
 * PayPal navigation bar item with icon and label content slots. Wraps Material 3
 * [NavigationBarItem].
 *
 ...
 */
@Composable
fun RowScope.PayPalNavigationBarItem(
    selected: Boolean,
    onClick: () -> Unit,
    ...
    NavigationBarItem(
        ...
        colors = NavigationBarItemDefaults.colors(
            ...
            unselectedTextColor = PayPalNavigationDefaults.navigationContentColor()
        )
    )
}

/**
 * PayPal navigation bar with content slot. Wraps Material 3 [NavigationBar].
 *
 ...
 */
@Composable
fun PayPalNavigationBar(
    modifier: Modifier = Modifier,
    content: @Composable RowScope.() -> Unit
) {
    NavigationBar(
        modifier = modifier,
        contentColor = PayPalNavigationDefaults.navigationContentColor(),
        tonalElevation = 0.dp,
        content = content
    )
}
